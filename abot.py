...
@bot.command()
async def help(ctx):
    embed = discord.Embed(title="Prefix: ?", description="A list of all available commands",
                          color=discord.Color.purple())
    member = ctx.message.author
    embed.set_author(name="Help", icon_url="{}".format(member.avatar_url))
    embed.add_field(name="Prune", inline=False, value='Deletes specified amount of messages.')
    embed.add_field(name="Kick", inline=False, value='Removes a member from your server.')
    embed.add_field(name="Ban", inline=False, value='Bans a member from your server.')
    embed.add_field(name="Avatar (id/ping)", inline=False, value='Returns the avatar of the user.')
    embed.add_field(name="Info", inline=False, value='Returns information about user.')
